...
namespace DOTS_BLE
{
    public class DOTS_FFTProcess : MonoBehaviour
    {
        ...
        private void PowerSpectrum(double[] fft, int channel)
        {
            ...
            switch (channel)
            {
                ...
                case 1:     //ch1
                    ...
                    deviceReader.CatchData(EEG1_PSum, 311);
                    deviceReader.CatchData(EEG1_PAverage, 312);
                ...
                case 2:     //ch2
                    ...
                    deviceReader.CatchData(EEG2_PSum, 321);
                    deviceReader.CatchData(EEG2_PAverage, 322);
                ...
                case 3:     //ch3 PPG값 검출
                    ...
                    deviceReader.CatchData(ch3PIndex[SlidePosition], 331);
